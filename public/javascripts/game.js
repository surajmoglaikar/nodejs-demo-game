var camera, controls, scene, renderer, raycaster, timer;;
...
function init() {
    ...
    console.log('container issS:', $container[0])
...
function computerTakeTurn() {
        var filteredCubes = cubes.filter((cube) => cube.material.color !== PLAYER_1_COLOR || 
        cube.material.color !== PLAYER_2_COLOR);
        
        var cube = cubes[Math.floor(Math.random() * filteredCubes.length)];
